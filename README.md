...
6. ВЫДЕРЖЕНА АБСТРАКЦИЯ. ПОДДЕРЖИВАЕТСЯ ВОЗМОЖНОСТЬ РАБОТЫ ПРИЛОЖЕНИЯ С МНОЖЕСТВОМ ТАКИХ ЖЕ ПРИЛОЖЕНИЙ, ТО ЕСТЬ ВОЗМОЖНО,НАПРИМЕР, ОТПРАВЛЯТЬ С НЕКОЛЬКИХ ПРИЛОЖЕНИЙ СООБЩЕНИЕ НА ОДНО ПРИЛОЖЕНИЕ, И НАОБОРОТ 
